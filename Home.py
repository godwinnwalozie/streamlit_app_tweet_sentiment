...
with st.container():
    ...
    with col1:
        ...
        with st.container():
            ...
            tweet = st.text_input('write a product review', 'Example, the product didnt last more than a month of use') 
...
with col2:
    ...
    def wordcloud_pos ():
        ...
        wc= WordCloud(max_words = 6000,background_color = "black", height=250).generate(text)
